...
// // Reminder system using alert()
// if (remainingHours > 0 && daysLeftInWeek > 0) {
//         const percentLeft = (remainingHours / required) * 100;
    
//         if (percentLeft > 40 && daysLeftInWeek <= 2) {
//             const hoursPerDay = remainingHours / daysLeftInWeek;
//             const hrs = Math.floor(hoursPerDay);
//             const mins = Math.round((hoursPerDay - hrs) * 60);
    
//             const reminderMsg = `Reminder:\nYou have ${remainingHours} hours left.\nYou need to work about ${hrs}h ${mins}m per day for the next ${daysLeftInWeek} day(s) to meet your goal.`;
//             alert(reminderMsg);
//         }
//     }
